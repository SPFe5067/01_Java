...
public class SetSurvice {
	...
	public void method1() {
		...
		// -> HashSet 순서 유지 X
		// -> TreeSet 가나다순 자동 정렬 O 
		// -> LinkedHashSet 순서 유지 O
		...
		System.out.println(set);
		System.out.println(set.remove("KTservice"));
	...
	public void method2() {
		...
		System.out.println("[Interator로 변환 하는 방법]");
		//boolean을 반환하는 Iterator.hasNext() : 
		...
		System.out.println("[List로 변환 하는 방법]");
	...
	public void method3() {
		...
		//A.equals(B) : A와 B가 가지고있는 필드값이 전부 같다면 true 아니면 false.
	 ...
	 * 금액 입력 : 3000
	 * 
	 * 1회 : [11, 20, 22, 32, 35, 45]
	 * 2회 : [10, 21, 24, 26, 42, 43]
	 * 3회 : [13, 24, 25, 29, 34, 42]
	 * 
	 */
	...
	//생성된 로또 번호 묶음(TreeSet)을 저장할 List 객체 생성
		...
		for(int i = 0; i < amount/1000; i++) {
			...
			//Comparator.reverseOrder()는 내림차순 이다.
			Random random = new Random();
